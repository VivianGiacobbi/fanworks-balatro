...
This mod features a plethora of additions to the base game, including:
- **85 Jokers**
- **44 Stands***
- **2 Spectrals**
- **4 Vouchers**
...
- **15 Challenges**
- **62 Achievements**
- And a ton of easter eggs and secrets!
...
3. Once all dependencies are installed, download the [latest release](https://github.com/VivianGiacobbi/fanworks-balatro/releases/tag/v1.0.2) and extract the `fanworks-1.0.2` folder into your mods directory. You're all set!
...
Detailed credits are available in-game in the credits tab - `Mods > JoJo's Balatro Fanworks > Credits`
