...
function jokerInfo.calculate(self, card, context)
    ...
    if context.other_card.ability.mult > 0 then
        if context.other_card.ability.effect == "Lucky Card" and SMODS.pseudorandom_probability(self, 'lucky_mult', 1, 5, 'lucky_mult') then
    ...
    if context.other_card.ability.p_dollars > 0 then 
        if context.other_card.ability.effect == "Lucky Card" and SMODS.pseudorandom_probability(self, 'lucky_money', 1, 15, 'lucky_money') then
            context.other_card.lucky_trigger = true
