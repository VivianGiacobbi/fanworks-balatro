...
return {
	misc = {
		...
		dictionary = {
			...
			k_farewell = 'Farewell!',
			k_grafted = 'Grafted!',
			k_stand_advance = 'Advanced!',
			k_stand_revert = 'Reverted!',
	...
	descriptions = {
		...
		Joker = {
			j_fnwk_streetlight_fledgling = {
				...
				text = {
					...
					"cause the score to {C:attention}catch fire{}",
			...
			j_fnwk_last_morse= {
				...
				text = {
					...
					"contains {C:attention}exactly #2#{}",
					"scoring {C:attention}ranks{}",
				},
			},
			j_fnwk_moscow_mule = {
				name = "Moscow Mule",
			...
			j_fnwk_sunshine_funkadelic = {
				...
				text = {
					"{X:mult,C:white}X#1#{} Mult if played hand",
					"contains a scoring {V:1}#2#{} card",
					"and a scoring {V:2}#3#{} card",
			...
			j_fnwk_rockhard_vasos = {
				...
				text = {
					...
					"{C:attention}+#2#{} instead if you have a {C:stand}Stand{}"
				}
			},
			...
			j_fnwk_jspec_joepie = {
				name = "Joepiejee",
				text = {
					"{C:attention}+#1#{} hand size per {C:planet}level{}",
					"of your lowest level",
					"{C:attention}basic poker hand{}",
			...
			j_fnwk_jspec_kunst = {
				...
				text = {
					...
					"defeated, {C:planet}level up{}",
					"every poker hand {C:attention}#1#{}"
				},
				unlock = {
					"{E:1,s:1.3}?????{}"
				}
			...
			j_fnwk_fanworks_jester = {
				...
				text = {
					...
					"create a random {C:fanworks}Fanworks{} {C:attention}Joker{}",
				}
			},
			...
			j_fnwk_mdv_shock = {
				...
				text = {
					...
					"of the next {C:attention}#1#{} hands played"
				}
			},
			j_fnwk_jojojidai_soldiers = {
				name = "Jokers of Fortune",
				text = {
					"{X:mult,C:white}X#1#{} Mult for each {C:attention}1{}",
					"hand size below {C:attention}#2#{} cards",
			...
			j_fnwk_city_neet = {
				name = "NEET Jokestar",
				text = {
					"{X:mult,C:white}X#1#{} Mult if no other",
					"Jokers are {C:attention}titled{}",
					"\"Joker\" or \"Jokestar\"",
				}
			},
			j_fnwk_cis_jokestar = {
				...
				text = {
					"{C:mult}+#1#{} Mult",
					"{S:1.1,C:red,E:2}Self destructs{} after score",
			...
			j_fnwk_yym_sheet = {
				...
				text = {
					...
					"every time a {C:attention}Booster Pack{}",
					"is opened",
					"{C:inactive}(Currently {}{C:chips}+#1#{}{C:inactive} Chips){}"
				}
			},
		...
		Spectral = {
			...
			c_fnwk_spec_mood = {
				name = "Mood Indigo",
				text = {
					"Convert the {C:attention}leftmost Joker{}",
					"into a different Joker of the",
					"same {C:attention}rarity{}, preserving {C:dark_edition}edition{}"
				}
			}
		},
		Stand = {
